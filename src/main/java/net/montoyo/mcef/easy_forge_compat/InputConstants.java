...
public class InputConstants {
    ...
    public static final class Key {
        ...
        Key(String p_84860_, InputConstants.Type p_84861_, int p_84862_) {
            ...
            this.type = p_84861_;
            this.value = p_84862_;
            this.displayName = p_84861_.displayTextSupplier.apply(p_84862_, p_84860_);
    ...
    public static enum Type {
        KEYSYM("key.keyboard", (p_84914_, p_84915_) -> {
            ...
            return s != null ? new TranslationTextComponent(s) : new TranslationTextComponent(p_84915_);
        }),
        SCANCODE("scancode", (p_84911_, p_84912_) -> {
            String s = GLFW.glfwGetKeyName(-1, p_84911_);
            return s != null ? new TranslationTextComponent(s) : new TranslationTextComponent(p_84912_);
        }),
        MOUSE("key.mouse", (p_84904_, p_84905_) -> {
            return LanguageMap.getInstance().has(p_84905_) ? new TranslationTextComponent(p_84905_) : new TranslationTextComponent("key.mouse", p_84904_ + 1);
        });

        private final Int2ObjectMap<InputConstants.Key> map = new Int2ObjectOpenHashMap<>();
        final String defaultPrefix;
        final BiFunction<Integer, String, TextComponent> displayTextSupplier;
        ...
        private Type(String p_84893_, BiFunction<Integer, String, TextComponent> p_84894_) {
